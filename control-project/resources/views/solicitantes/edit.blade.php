...
@section('content')
    <div class="space-y-6">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <p class="text-sm uppercase tracking-[0.3em] text-orange-600">Editar solicitante</p>
                <h2 class="text-2xl font-semibold text-slate-900">Atualizar dados do solicitante</h2>
            </div>
